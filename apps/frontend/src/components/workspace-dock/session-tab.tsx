 ...
 * its close rewired to `onRemovePane` so a tab's × and `<SessionPane>`'s
 ...
 * Wiring removal to that event would delete a pane's session the moment the
 ...
 * refreshes every poll), so the marker follows `sessionWaitingSince` without
