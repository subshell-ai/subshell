...
function renderPage() {
  ...
  const usersRoute = Route.update({
    ...
    // biome-ignore lint/suspicious/noExplicitAny: re-parenting a file route onto a test root, as in nodes-detail.test.tsx
  } as any);
  ...
  render(
    <QueryClientProvider client={client}>
      {/* biome-ignore lint/suspicious/noExplicitAny: the test router's tree is narrower than the app's */}
