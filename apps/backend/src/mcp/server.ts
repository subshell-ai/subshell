...
import { z } from "zod";
import { MoteApi } from "@/mcp/api-client.js";
import type { IdentityKeyPair } from "@/mcp/crypto.js";
import { readMcpEnv } from "@/mcp/env.js";
import { loadOrCreateIdentity } from "@/mcp/identity-store.js";
import type { ToolApi } from "@/mcp/tools.js";
import {
  channelMembers,
  createChannel,
  createSession,
