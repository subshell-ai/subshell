 ...
 * `serde_json::Value`.
 *
 * So this interface describes `apps/client/src/cli.ts`'s body, not a Rust
...
/** `ServiceRunState` in `apps/client/src/service.ts`. */
...
/** `subshell service status --json` — `ServiceState` in `apps/client/src/service.ts`. */
 ...
 *
 * `stdout`/`stderr` are rendered as-is and never re-worded: `apps/client`
