 ...
 * `--target` for every triple and why this is one formula, not a native/cross
 * pair.
 */
...
async function main(): Promise<void> {
  ...
  // machine cannot run is never what an unscoped local call is for. (Old
  // comment here said tauri "cannot cross-compile" — it links against the
  // host webview on LINUX; macOS links the SDK's universal WebKit, measured
  // 2026-09-25.)
