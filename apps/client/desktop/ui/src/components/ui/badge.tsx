// Copied from apps/server/web/src/components/ui/badge.tsx — verbatim except the
...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 font-strong text-xs transition-colors",
  {
    variants: {
      variant: {
