// Copied from apps/server/web/src/components/ui/button.tsx — verbatim except the
...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-strong text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // links/glows. The five values are palette tokens — the --button-primary-*
        // lines in styles.css.
        default:
          "border-transparent bg-[linear-gradient(135deg,var(--button-primary-from),var(--button-primary-to))] text-[var(--button-primary-foreground)] hover:bg-[linear-gradient(135deg,var(--button-primary-hover-from),var(--button-primary-hover-to))]",
      ...
      size: {
        ...
        sm: "h-8 rounded-md px-3 text-detail",
