...
Connect this machine to your NetBird network, where the join is already the publish.
...
- [Networking and addresses](/server/networking): the allowlist a join feeds
