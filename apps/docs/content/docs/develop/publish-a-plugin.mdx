...
Publish `dist/` and your icon in `files`, keep `subshell.entry` a relative path inside the package, and pin nothing about your consumer; your build already inlined `@subshell-ai/plugin-api` (see [The Plugin API](/develop/plugin-api)).
