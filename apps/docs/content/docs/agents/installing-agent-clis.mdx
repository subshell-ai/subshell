...
- The **Add an Agent** screen of the first-run wizard, right after you create the account.
...
Each agent row shows its detection state, and beside the Install button, **the exact command it will run** — no click is needed to find out what you are about to do.
