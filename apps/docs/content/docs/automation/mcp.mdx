...
description: "The stdio MCP server every subshell gets: how it is launched, authenticated, and registered with each harness."
---
...
- **[Hermes](/agents/hermes)** and **[pi](/agents/pi)** have no per-subshell config format, so you register once, manually. The [Presets](/use/presets) page's editor shows the exact command, ready to copy.
...
- [MCP Tools](/reference/mcp-tools): the fifteen tools themselves
