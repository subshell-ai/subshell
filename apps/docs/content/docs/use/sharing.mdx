...
- **edit** — view, plus drive it: type into the live terminal, rename it, restart it, and terminate it. (The terminate route honors an edit grant even though the interface stopped offering the button.)
