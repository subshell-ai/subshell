...
- [Launch and manage subshells](/use/subshells): the pane's resident process and its lifecycle
- [Devices](/use/devices): why the pane is the size it is
- [Share a subshell](/use/sharing): what others see when you share a workspace pane
