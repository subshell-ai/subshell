...
5. **Connected**: the node's live state, whether it is online and what the service manager says. Doing step 3 again deliberately is the **Re-enroll…** act, offered separately beside the control plane's address.
