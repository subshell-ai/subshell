...
- [Add a node](/nodes/add-a-node): the same enrollment from a terminal, one command.
- [Manage a node](/nodes/manage): service controls, logs, and repointing from the browser.
- [Nodes overview](/nodes): what registering this machine actually delegates.
