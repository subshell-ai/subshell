...
description: "Every variable the server and the node read: what each one controls, its default, and whether config.env can carry it or only the process environment."
---
