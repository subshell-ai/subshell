...
import { restartNodeRoute } from "@/api/nodes/restart-node.route.js";
 ...
 * `detect` command, §6.2) and restart (the signed `restart` command, spec
 * 2026-09-12 §6.3). Plugins left this surface entirely: the instance
