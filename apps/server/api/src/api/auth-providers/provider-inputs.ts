 ...
 * The provider's name is rendered on the ANONYMOUS sign-in buttons and inside
...
/** The one refusal sentence every last-provider guard shares (spec §8). */
export const LAST_PROVIDER_MESSAGE =
  "This would leave no way to sign in. Turn on another provider first, or use SUBSHELL_EMERGENCY_PASSWORD from the CLI.";
