...
/** The three placements the add-subshell dialog offers, in display order. */
...
/**
 * Chooses where an added subshell lands.
 *
 ...
 * add, not three different lists of the same subshells.
 */
export function DirectionSelect({
  ...
  return (
    <Segmented
      ariaLabel="Where to add the subshell"
