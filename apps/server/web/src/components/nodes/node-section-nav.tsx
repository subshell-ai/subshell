 ...
 *
 * Hiding the link is not gating the URL: since the sections became real
 * top-level routes (2026-09-20), `/nodes/local/service` is reachable by
 * typing, and it must answer with the Overview the nav shows rather than a
 * card whose route 400s (or, worse, with "this node is offline" about a
 * live control-plane host). The server still enforces the refusal — this
 * only keeps the page honest about it.
 *
