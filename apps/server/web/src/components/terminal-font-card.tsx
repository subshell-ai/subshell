    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          resize immediately. Bigger text fits fewer columns, so leave the browser's own page zoom at 100%: a zoomed
          page shrinks the whole window on home-screen installs.
        </CardDescription>
      </CardHeader>
      <CardContent>
