// biome-ignore-all lint/suspicious/noControlCharactersInRegex: this probe
// tokenizes RAW TERMINAL BYTES — control characters in these regexes are the
// subject matter, not a mistake. File-level because the escapes appear in six
// separate expressions and the formatter keeps splitting a per-line
// suppression away from the line it suppresses.
