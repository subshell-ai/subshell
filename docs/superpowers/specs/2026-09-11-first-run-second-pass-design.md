...
┌────────────────────────────────────────────────────────────┐ 1024 × 720
│                                                            │
│                        [ illustration 96 ]                 │  top zone: 96px breathing above the art
│                                                            │
...
- **Illustration:** 96px. The app icon (`icons/128x128@2x.png`, already in
  the bundle) on Welcome; a monochrome glyph in `--primary` at 20% on
  every other screen (terminal, server, key, robot, rocket — `lucide` in
  the SPA, inline SVG of the same five in the native page).
...
Illustration: the app icon. Title **Welcome to Subshell**. Subtitle *Subshell
